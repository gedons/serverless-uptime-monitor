  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 px-4 py-8">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-400 mt-1">Start monitoring your services for free</p>
      </div>
        ...
        <form @submit.prevent="handleRegister" class="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              class="w-full px-4 py-3 bg-gray-900/60 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500/60 transition-all duration-200 disabled:opacity-50"
            />
            <p class="text-xs text-gray-500 mt-1">Must contain at least 8 characters, numbers, and uppercase/lowercase letters.</p>
          </div>
...
useHead({
  title: "Create Account - Serverless Uptime Monitor"
});
...
async function handleRegister() {
  ...
  try {
    ...
    await signUp(cleanEmail, password.value);
    await navigateTo(`/confirm-account?email=${encodeURIComponent(cleanEmail)}`);
  } catch (err: any) {
